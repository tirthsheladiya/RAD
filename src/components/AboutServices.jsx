    ...
    return (
        <section className="about-services">
            ...
            <div className="founder-section">
                ...
                <img src="/assets/car.png" className="founder-car" alt="" />
                <div className="founder-card">
                    <div className="left">
                        
                       
                        
                        <img src="/assets/founder-photo.png" className="founder-photo" alt="" />
                         <img src="/assets/founder-glow.png" className="founder-glow" alt="" />
                    </div>
                    <div className="right">
                        ...
                        <div className="founder-text">
                            <p>Nilesh is the founder of RAD Worldwide and sports, entertainment and licensing strategist with over 10 years of experience across global rights holders, IP owners and consumer products.<br/><br/>

                                Distinctive ability to bridge fan culture with commercial strategy, turning engagement into structured licensing ecosystems and scalable revenue.<br/><br/>

                                Focused on building sports and entertainment IPs and the next generation of micro-IPs and into global commercial platforms.<br/><br/>

                                Career spanning work with global organisations including Chelsea FC, Arsenal FC, Real Madrid CF, Sevilla FC, and Major League Baseball, leading fan engagement, brand expansion and international market growth initiatives and building and managing licensing programs in entertainment, celebrities and sports.</p>
                        </div>
                    </div>
                </div>
            </div>
